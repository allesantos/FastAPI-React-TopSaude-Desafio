...
Revision ID: 4ac470981dab
Revises: 
Create Date: 2025-12-06 00:59:41.936844
...
def upgrade() -> None:
    ...
    op.create_index('idx_product_active_sku', 'products', ['is_active', 'sku'], unique=False)
    ...
    op.create_index('idx_order_customer_status', 'orders', ['customer_id', 'status'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_order_customer_status', table_name='orders')
    op.drop_index('idx_order_created_at', table_name='orders')
    op.drop_table('orders')
    op.drop_index(op.f('ix_products_sku'), table_name='products')
    op.drop_index(op.f('ix_products_id'), table_name='products')
    op.drop_index('idx_product_active_sku', table_name='products')
